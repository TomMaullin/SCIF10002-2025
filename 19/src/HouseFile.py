...
class mysticalBook:
    ...
    def performIncantation(self, incantation): #TODO
        ...
        if incantation.lower()=='raindance':
            ...
            print(" ")
            time.sleep(2.5)
            print("You fool. Did you really think that would work?!")
            time.sleep(2.5)
            print(" ")
            time.sleep(2.5)
            print('Wait...')
            ...
            print(" ")
            time.sleep(2.5)
            print('You fool!! You just remembered!')
            time.sleep(2.5)
            print(" ")
            time.sleep(2.5)
...
class House:
    ...
    def roomDescription(self, roomName): 
        ...
        # Chamber of death, for book
            ...
            print(" ")
            time.sleep(1)
            print("Hey wait! What's this?! A weird mystical book! Maybe you should keep hold of this... I'd save the result of this function call if I were you (e.g. `book=house.roomDescription('ChamberOfDeath')`)!")
            time.sleep(1)
            print(" ")
            time.sleep(1)
    ...
    def isItemInRoom(self, itemName, roomName):
        ...
        if itemName.lower() == 'dog' and not self.__foundDog:
            ...
            print(" ")
            time.sleep(1)
            print("Maybe there's a clue *described* in a room somewhere!")
        ...
        # Check if the valves in the room
            ...
            if roomName.lower() == 'bedroom':
                ...
                # Otherwise, finding valve for first time
                    ...
                    print("Why would anyone ever put a sprinkler valve in a bedro... Wait! What?! It's here!!")
                    time.sleep(1)
                    print(" ")
                    time.sleep(1)
                    print("Oh no! The valves been locked with a padlock! I wonder where the key is...")
                    time.sleep(1)
                    print(" ")
                    time.sleep(1)
                    print("Right...")
